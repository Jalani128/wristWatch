...
export const comingSoonStyles = {
  ...
  // Watches Container
watchesContainer: "w-full",
   watchesRow: "flex gap-8 items-start justify-between",
  ...
  formatPKR: (n) => `₨ ${n.toLocaleString("en-PK")}`
};
...
const contactPageStyles = {
  // Page layout
  pageContainer: "min-h-screen bg-white py-12 sm:py-16 md:py-16 px-4 sm:px-6 md:px-8 lg:px-12",
  ...
  // Main grid
  mainGrid: "grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start",
...
export const ordersPageStyles = {
  ...
  innerContainer: "container mx-auto px-4 py-6 sm:px-6 sm:py-8 md:py-10 lg:py-8",
  headerContainer: "flex flex-col sm:flex-row sm:items-center justify-between mb-6",
  titleContainer: "flex items-center space-x-3",
  titleIcon: "h-5 w-5",
  refreshButton: "px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors",
  loadingText: "text-center text-gray-500 py-4",
  errorText: "text-center text-red-500 py-4",
  ordersContainer: "mt-6",
  emptyStateContainer: "text-center py-12",
  emptyStateText: "text-gray-500",
  orderCard: "bg-white rounded-xl shadow-md overflow-hidden mb-6",
  orderHeader: "flex flex-col sm:flex-row sm:items-center justify-between p-6",
  orderTitle: "text-xl font-semibold text-gray-900",
  orderDateContainer: "flex items-center space-x-2 text-sm text-gray-500",
  orderDateIcon: "h-4 w-4",
  statusAndActions: "flex flex-col sm:flex-row sm:items-center justify-between mt-4",
  statusBadgeBase: "px-2 py-1 text-xs font-medium rounded-full",
  ...
  toggleButton: "px-3 py-1 bg-gray-100 text-gray-800 rounded hover:bg-gray-200 transition-colors",
  toggleIcon: "h-4 w-4",
  cancelButtonBase: "px-3 py-1 text-sm font-medium rounded transition-colors",
  cancelButtonDisabled: "bg-gray-200 text-gray-400 cursor-not-allowed",
  cancelButtonEnabled: "bg-red-100 text-red-800 hover:bg-red-200",
  itemsGrid: "grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4",
  itemCard: "flex items-center space-x-3",
  itemImage: "h-16 w-16 object-cover rounded",
  itemNoImage: "h-16 w-16 bg-gray-200 rounded flex items-center justify-center text-gray-400",
  itemDetails: "flex-1",
  itemName: "font-medium text-gray-900",
  itemPrice: "text-gray-600",
  itemQuantity: "text-gray-500",
  deliveryDetailsContainer: "mt-6",
  deliveryTitle: "text-xl font-semibold text-gray-900 mb-4",
  deliveryIcon: "h-5 w-5",
  deliveryGrid: "grid grid-cols-1 gap-2 sm:grid-cols-2",
  deliveryLabel: "text-sm font-medium text-gray-600",
  totalContainer: "mt-4 flex items-center justify-between text-lg font-semibold",
  totalLabel: "text-gray-600",
  totalAmount: "text-gray-900",
};
