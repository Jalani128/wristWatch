       ...
       if (data && data.token) {
         ...
         try {
           window.dispatchEvent(
             new Event("authChanged", { detail: { loggedIn: true } })
           )
         } catch (err) {
           // ignore
         }
         ...
         toast.error(data.message || "Unexpected error form server", {
           position: "top-right",
           autoClose: 4000,
           theme: "light",
         })
    ...
    <div className={loginPageStyles.pageContainer} style={{
      ...
      <div className={loginPageStyles.mainContent}>
        ...
        <div className={loginPageStyles.loginCard}>
          ...
          <p className={loginPageStyles.cardSubtitle}>Sign in to your account</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className={loginPageStyles.formField}>
              ...
              <div className={loginPageStyles.inputContainer}>
                ...
                <input type="email" id="email" className={loginPageStyles.inputBase}
            ...
            <div className={loginPageStyles.formField}>
              ...
              <div className={loginPageStyles.inputContainer}>
                ...
                <input type={showPassword ? "text" : "password"}
                  id="password" className={loginPageStyles.passwordInputBase}
                ...
                <button type='button' className={loginPageStyles.passwordToggle}
            ...
            <div className={loginPageStyles.rememberMeContainer}>
              <div className={loginPageStyles.checkboxContainer}>
                <input type="checkbox" id="rememberMe" className={loginPageStyles.checkbox}
                  checked={rememberMe}
                  onChange={() => setRememberMe(!rememberMe)}
                  disabled={submitting} />
              </div>
              <div className={loginPageStyles.checkboxLabelContainer}>
                <label htmlFor="remember" className={loginPageStyles.checkboxLabel}>
                  Remember Me {" "}
            ...
            <button type="submit" className={`${loginPageStyles.submitButton}${
              submitting ? loginPageStyles.submitButtonLoading : ""
              }`}
              disabled={submitting}>
