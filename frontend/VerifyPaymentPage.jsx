...
const VerifyPaymentPage = () => {
  ...
  useEffect(() =>{
    ...
    const verifyPayment = async () => {
      ...
      try {
          setStatusMsg("Confirmig Payment with server...");
    ...
    <div className='min-h-screen flex items-center justify-center text-white p-4'>
      <div className='text-center max-w-lg'>
        ...
        <p className='text-sm opacity-70'>
          It this page shows "session not found", try creating the session again.
          Or contact with the support.
        </p>
      </div>
    </div>
  )
...
// for the payment to be paid and order place we require this.