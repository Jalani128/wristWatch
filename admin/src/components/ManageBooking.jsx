...
import { bookingStyles, statusBadgeStyles, paymentBadgeBaseStyles, paymentBadgeStyles, badgeBaseStyles } from '../assets/dummyStyles'
import axios from 'axios';
import { Calendar, ChevronDown, CreditCard, MapPin, MessageSquare, Phone, Search, Trash2, User, Watch } from 'lucide-react';
...
const ManageBooking = () => {
    ...
    // to update the status of a order
        ...
        <div className={bookingStyles.root}>
            <div className={bookingStyles.container}>
                <div className={bookingStyles.headerContainer}>
                    ...
                    <div>
                        <h1 className={bookingStyles.headerTitle}>Manage Bookings</h1>
                        <p className={bookingStyles.headerSubtitle}>View and manage customer bookings</p>
                    </div>
                </div>
                <div className={bookingStyles.infoCard}>
                    <div className={bookingStyles.filterContainer}>
                        <h2 className={bookingStyles.infoCardTitle}>All Bookings ({filtered.length})</h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <div className={bookingStyles.filterSelectContainer}>
                                <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className={bookingStyles.filterSelect}>
                ...
                <div className={bookingStyles.bookingsContainer}>
                    {loading && (
                        <div className={bookingStyles.loadingText}>Loading booking...
                        </div>
                    )}
                    {error &&
                        <div className={bookingStyles.errorText}>{error}</div>}
                    {filtered.length === 0 ? (
                        <div className={bookingStyles.noBookingsContainer}>
                            <Calendar className={bookingStyles.noBookingsIcon} />
                            <p className={bookingStyles.noBookingsText}>No bookings found.</p>
                        </div>
                                    ...
                                    <div className={bookingStyles.bookingHeader}>
                                        <div className={bookingStyles.customerContainer}>
                                            ...
                                            <div className='min-w-0'>
                                                <h3 className={bookingStyles.customerName}>{b.customerName}</h3>
                                                <p className={bookingStyles.customerInfo}>{b.email}{" "}
                                                    <span className={bookingStyles.customerSeparator}>&dot;</span>
                                                    <span className={bookingStyles.orderId}>Order:{" "}
                                                        <span className={bookingStyles.orderIdValue}>{b.orderId}</span>
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                        <div className={bookingStyles.actionsContainer}>
                                            ...
                                            <div className={bookingStyles.actionButtonGroup}>
                                                <select
                                                    ...
                                                    className={`${bookingStyles.statusSelect} ${isCancelled
