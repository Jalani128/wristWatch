...
const API_BASE = import.meta.env.VITE_API_URL || "http://localhost:4000";
    ...
    // any input changes given by user in the input fields
    ...
    // aftr submit reset th form to its inital value
    const resetForm = () => {
        setName("");
        setDescription("");
        setPrice("");
                ...
                <div className={classes.gridContainer}>
                    <form onSubmit={handleSubmit} className={classes.formContainer(theme)}>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <label htmlFor="watch-image" className={classes.uploadButton}>
                                        ...
                                        <input id='watch-image' ref={inputRef} type='file' accept='image/*'
                        ...
                        <div>
                            ...
                            <input value={name} onChange={(e) => setName(e.target.value)} placeholder='e.g Classic Silver Chrono' className={inputClass}
                            required
                            disabled={loading} />
                        </div>
                        <div>
                            ...
                            <select value={category} onChange={(e ) =>setCategory(e.target.value)} className={inputClass} disabled={loading} required>
                        ...
                        {category === "brand" && (
                            ...
                            <div className={classes.formLabelSimple}>
                             ...
                             <select value={brandName} onChange={(e) => setBrandName(e.target.value)} className={inputClass} disabled={loading} required>
                           ...
                           <div>
                            ...
                            <div className={classes.priceInputContainer}>
                                <input value={price} onChange={(e) => setPrice(e.target.value)} placeholder='199.99' inputMode='decimal' className={classes.priceInput(theme)}
                                required
                                disabled={loading} />
                            </div>
                         </div>  
